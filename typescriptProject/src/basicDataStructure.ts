...
const nums:number[][] = [[1,2,3],[4,5,6],[1,2,3]]
...
const arrValue : [string,number,boolean][]=[['apple',1,true],['orange',2,false],['watermelon',3,true]]
console.log('array of value arrays',arrValue[0][0],arrValue[1])

// Add Items to an Array with push() and unshift() 

const values:number[] = [1,2,3,4,4,5,67,8,9]
...
const oldArray : number[]= [1,2,3,4,5,67,3,4,5]
const newarr:number[] =[]
const k = 67

const superValue = (oldArray :number[]) : any =>{
...
let nameList :string[]= ['anuj','ram','ravi','prasad']
...
let student:any[]=[...nameList,'vino',...id,5]
...
let arrLoop:number[] =[11,12,33,42,75,96];
...
// get array of keys from objects
